...
public class HomePage extends BasePage {
    ...
    private void createPage() {
        ...
        DataView<Season> dataView = new DataView<Season>("rows", seasonDataProvider, 10) {
            ...
            protected void populateItem(final Item<Season> listItem) {
                ...
                listItem.add(new Button("editAddress") {

                    private static final long serialVersionUID = 1L;

                    private void edit() {
                        setResponsePage(new SeasonEditor(HomePage.this, Model.of(((Season) listItem
                                .getDefaultModelObject()).clone())) {

                            private static final long serialVersionUID = 1L;

                            @Override
                            protected void onSeasonChange(Season season) {
    ...
    public static BookmarkablePageLink<Void> link(final String name, final Season season) {

        final BookmarkablePageLink<Void> link = new BookmarkablePageLink<Void>(name, PublicPage.class);
