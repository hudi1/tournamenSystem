...
CREATE TABLE IF NOT EXISTS `PLAY_OFF_GAME` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `HOME_PLAYER_RESULT_ID` int(11) DEFAULT NULL,
  `AWAY_PLAYER_RESULT_ID` int(11) DEFAULT NULL,
  `GROUP_ID` int(11) NOT NULL,
...
ALTER TABLE `PLAY_OFF_GAME`
  ADD CONSTRAINT `PLAY_OFF_GAME_ibfk_1` FOREIGN KEY (`HOME_PLAYER_RESULT_ID`) REFERENCES `PLAYER_RESULT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `PLAY_OFF_GAME_ibfk_2` FOREIGN KEY (`AWAY_PLAYER_RESULT_ID`) REFERENCES `PLAYER_RESULT` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
