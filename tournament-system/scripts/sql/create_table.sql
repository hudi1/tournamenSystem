...
CREATE TABLE IF NOT EXISTS `GROUPS` (
  ...
  `PLAY_OFF_TYPE` enum('F','L') NOT NULL DEFAULT 'L',
  PRIMARY KEY (`ID`),
...
ALTER TABLE `PLAY_OFF_GAME`
  ADD CONSTRAINT `PLAY_OFF_GAME_ibfk_2` FOREIGN KEY (`GROUP_ID`) REFERENCES `GROUPS` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `PLAY_OFF_GAME_ibfk_1` FOREIGN KEY (`GAME_ID`) REFERENCES `GAME` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
