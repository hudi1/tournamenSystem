...
public class NameGenerator {
    ...
    public NameGenerator() {
        ...
        String demoStartConsonants[] = { "b", "c", "d", "f", "g", "h", "k", "l", "m", "n", "p", "q", "r", "s", "t",
                "v", "w", "x", "z", "ch", "bl", "br", "fl", "gl", "gr", "kl", "pr", "st", "sh", "th" };
     ...
     *            Use only the following letters: (v=vocal,c=startConsonsonant,d=endConsonants)! Pass something like
     *            {"vd", "cvdvd", "cvd", "vdvd"}
     */
