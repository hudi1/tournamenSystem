...
public class Tournament implements Serializable {
	...
	public Tournament(String name, Season season, Integer finalPromoting, Integer lowerPromoting, Integer winPoints, Integer playOffFinal, Integer playOffLower, Integer minPlayersInGroup, TournamentSortType sortType, Boolean publish) {
		this.name = name;
		this.season = season;
	...
	public Tournament _setPublish(Boolean publish) {
		this.publish = publish;
		return this;
	}
	...
	public String toString() {
		return "Tournament [id=" + id + ", playOffLower=" + playOffLower + ", winPoints=" + winPoints + ", finalPromoting=" + finalPromoting + ", name=" + name + ", sortType=" + sortType + ", lowerPromoting=" + lowerPromoting + ", minPlayersInGroup=" + minPlayersInGroup + ", publish=" + publish + ", playOffFinal=" + playOffFinal + "]";
	}

	public String toStringFull() {
		return "Tournament [id=" + id + ", name=" + name + ", season=" + season + ", finalPromoting=" + finalPromoting + ", lowerPromoting=" + lowerPromoting + ", winPoints=" + winPoints + ", playOffFinal=" + playOffFinal + ", playOffLower=" + playOffLower + ", minPlayersInGroup=" + minPlayersInGroup + ", sortType=" + sortType + ", publish=" + publish + ", groups=" + groups + ", finalStandings=" + finalStandings + "]";
	}
}
