...
public class Tournament implements Serializable {
    ...
    public Tournament(String name, Season season, Integer finalPromoting, Integer lowerPromoting, Integer winPoints,
            Integer playOffA, Integer playOffLower, Integer minPlayersInGroup) {
        this.name = name;
        this.season = season;
    ...
    public String toString() {
        return "Tournament [id=" + id + ", playOffLower=" + playOffLower + ", playOffA=" + playOffA + ", winPoints="
                + winPoints + ", finalPromoting=" + finalPromoting + ", name=" + name + ", lowerPromoting="
                + lowerPromoting + ", minPlayersInGroup=" + minPlayersInGroup + "]";
    }

    public String toStringFull() {
        return "Tournament [id=" + id + ", name=" + name + ", season=" + season + ", finalPromoting=" + finalPromoting
                + ", lowerPromoting=" + lowerPromoting + ", winPoints=" + winPoints + ", playOffA=" + playOffA
                + ", playOffLower=" + playOffLower + ", minPlayersInGroup=" + minPlayersInGroup + ", groups=" + groups
