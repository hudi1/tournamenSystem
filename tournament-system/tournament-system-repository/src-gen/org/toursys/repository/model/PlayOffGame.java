...
public class PlayOffGame implements Serializable {
  ...
  private PlayOffGameStatus status;
  
  public PlayOffGameStatus getStatus() {
    return this.status;
  }
  
  public void setStatus(final PlayOffGameStatus status) {
    this.status = status;
  }
  
  public PlayOffGame _setStatus(final PlayOffGameStatus status) {
    this.status = status;
    return this;
  }
