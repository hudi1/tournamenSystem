...
public class UserIT {
	...
	public void createUserTest() {
		User user = userService.createUser(new User("email", "username", "password", UserRole.USER, 1, true));
	...
	public void updateUserTest() {
		int count = userService.updateUser(new User()._setId(1)._setEmail("emailEdit")._setName("nameEdit")
		        ._setPassword("passEdit")._setValidity(0)._setRole(UserRole.USER)._setSurname("surnameEdit")
