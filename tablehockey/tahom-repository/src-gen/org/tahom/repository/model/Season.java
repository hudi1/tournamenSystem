...
public class Season implements Serializable {
  ...
  public Season _setOnlyIds_(final boolean onlyIds_) {
    this.onlyIds_ = onlyIds_;
    return this;
  }
  ...
  public Season _setIds_(final List<Integer> ids_) {
    this.ids_ = ids_;
    return this;
  }
  ...
  public String toStringFull() {
    return "Season [id=" + id + ", name=" + name + ", user=" + user + ", tournaments=" + tournaments + ", onlyIds_=" + onlyIds_ + ", ids_=" + ids_ + "]";
  }
  ...
  public void setInit_(final Season.Association... associations) {
  ...
  public Season _setInit_(final Season.Association... associations) {
    setInit_(associations);
    return this;
  }
  
  public void clearInit_(final Season.Association... associations) {
    if (associations == null)
    	throw new IllegalArgumentException();
    for (Association association : associations)
  ...
  public Season _clearInit_(final Season.Association... associations) {
  ...
  public Season _setInit_(final String... associations) {
    setInit_(associations);
    return this;
  }
  ...
  public Season _clearInit_(final String... associations) {
    clearInit_(associations);
    return this;
  }
  
  public Boolean toInit_(final Season.Association association) {
    if (association == null)
    	throw new IllegalArgumentException();
  ...
  public void setOp_(final String operator, final Season.OpAttribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
  ...
  public Season _setOp_(final String operator, final Season.OpAttribute... attributes) {
    setOp_(operator, attributes);
    return this;
  }
  
  public void clearOp_(final Season.OpAttribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
    for (OpAttribute attribute : attributes)
  ...
  public Season _clearOp_(final Season.OpAttribute... attributes) {
    clearOp_(attributes);
    return this;
  }
  ...
  public Season _setOp_(final String operator, final String... attributes) {
    setOp_(operator, attributes);
    return this;
  }
  ...
  public Season _clearOp_(final String... attributes) {
    clearOp_(attributes);
    return this;
  }
  
  public void setNullOp_(final Season.OpAttribute... attributes) {
    if (attributes == null)
    	throw new IllegalArgumentException();
    for (OpAttribute attribute : attributes)
  ...
  public Season _setNullOp_(final Season.OpAttribute... attributes) {
  ...
  public Season _setNullOp_(final String... attributes) {
    setNullOp_(attributes);
    return this;
  }
